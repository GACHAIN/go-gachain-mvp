...
`sc_TXEditProfile #= contract TXEditProfile 
{
	...
	action 
	{
	  ...
	  DBUpdate(Table( "citizens"), $citizen, "name,name_middle,name_last,gender,avatar",$name_first,$name_middle,$name_last,$gender,$photo)
	}
}
    ...
    Divs(panel-body)
        Form()
            Divs(form-group)
                ...
                Label($name_middle$)
                Input(name_middle, "form-control input-lg m-b",text,"", #user_name_middle#)
                Label($name_last$)
        ...
        Divs(table-responsive)
            Table {
            	...
            	Columns: [
            		...
            		[Status,  Div(text-center text-bold, If(#flag_success#==1, Div(text-success,"success"),  If(#vCmpEndDate#<0, Div(text-muted, "finished"), If(#vCmpStartDate#<0, BtnPage(voting_view, Go, "vID:#id#",  btn btn-primary), Div(text-warning,"waiting") ) ) ) ), text-center h5 align="center" width="70"],
...
SetVar()
TextHidden( )
SetVar(`l_lang #= {" ResultSoon":"{\"en\": \" Result will be soon\", \"nl\": \" Result will be soon\", \"ru\": \"Результат будет скоро\"}","$voting_entry_number":"{\"en\": \"Poll #\", \"ru\": \"Poll #\"}","Actn":"{\"en\": \"Actions\", \"nl\": \"Acties\", \"ru\": \"Действия\"}","Actual":"{\"en\": \"Actual\", \"nl\": \"Actueel\", \"ru\": \"Текущие\"}","Ans":"{\"en\": \"Answer\", \"nl\": \"Antwoord\", \"ru\": \"Ответить\"}","Apps":"{\"en\": \"Applications\", \"ru\": \"Приложения\"}","Cancel":"{\"en\": \"Cancel\", \"nl\": \"Annuleer\", \"ru\": \"Отменить\"}","Chng":"{\"en\": \"Change\", \"nl\": \"Wijzigen\", \"ru\": \"Изменить\"}","Confirm":"{\"en\": \"Confirm\", \"nl\": \"Bevestig\", \"ru\": \"Подтвердить\"}","Contin":"{\"en\": \"Continues\", \"nl\": \"Doorgaan\", \"ru\": \"Продолжаются\"}","Continues":"{\"en\": \"Continues\", \"nl\": \"Doorgaan\", \"ru\": \"Продолжаются\"}","CreateNew":"{\"en\": \"Create new\", \"ru\": \"Создать новое\"}","DateFinishVoting":"{\"en\": \"Date Finish Voting\", \"nl\": \"Eind datum stem vraag\", \"ru\": \"Дата завершения голосования\"}","DateStartVoting":"{\"en\": \"Date Start Voting\", \"nl\": \"Begin datum stem vraag\", \"ru\": \"Дата начала голосования\"}","Del":"{\"en\": \"Delete\", \"nl\": \"Verwijdering\", \"ru\": \"Удалить\"}","EnterIssue":"{\"en\": \"Enter Issue\", \"nl\": \"Onderwerp\", \"ru\": \"Введите вопрос\"}","Finish":"{\"en\": \"Finish\", \"nl\": \"Einde\", \"ru\": \"Окончание\"}","Finished":"{\"en\": \"Finished\", \"nl\": \"Einde\", \"ru\": \"Завершено\"}","FinishedVotings":"{\"en\": \"Finished Votings\", \"nl\": \"Einde Stemmen\", \"ru\": \"Завершенные\"}","Fnsh":"{\"en\": \"Finish\", \"nl\": \"Einde\", \"ru\": \"Окончание\"}","Fnshd":"{\"en\": \"Finished\", \"nl\": \"Einde\", \"ru\": \"Завершено\"}","Gender":"{\"en\": \"Gender\", \"ru\": \"Пол\"}","GetResult":"{\"en\": \"Get Result\", \"nl\": \"Haa resultaat op\", \"ru\": \"Получить результат\"}","GovernmentDashboard":"{\"en\": \"Government dashboard\", \"nl\": \"Land overzicht\", \"ru\": \"Панель государства\"}","ID":"{\"en\": \"ID\", \"ru\": \"Номер\"}","Inf":"{\"en\": \"Info\", \"nl\": \"Info\", \"ru\": \"Информация\"}","Info":"{\"en\": \"Info\", \"nl\": \"Info\", \"ru\": \"Информация\"}","Iss":"{\"en\": \"Issue\", \"nl\": \"Onderwerp\", \"ru\": \"Вопрос\"}","Issue":"{\"en\": \"Issue\", \"nl\": \"Onderwerp\", \"ru\": \"Вопрос\"}","ListVotings":"{\"en\": \"List of Polling\", \"nl\": \"Stemlijst\", \"ru\": \"Опросы\"}","ListofApps":"{\"en\": \"List of applications:\", \"ru\": \"Список приложений:\"}","N":"{\"en\": \"No\", \"nl\": \"Nee\", \"ru\": \"Нет\"}","Name":"{\"en\": \"Name\", \"ru\": \"Название\"}","NewVoting":"{\"en\": \"New Polling\", \"nl\": \"Nieuwe vraag\", \"ru\": \"Новый опрос\"}","Next":"{\"en\": \"Next\", \"nl\": \"Naast\", \"ru\": \"Дальше\"}","No":"{\"en\": \"No\", \"nl\": \"Nee\", \"ru\": \"Нет\"}","NoAvailablePolls":"{\"en\": \"No Available Polls\", \"nl\": \"Geen beschikbare vragen\", \"ru\": \"Нет доступных голосований\"}","QuestionList":"{\"en\": \"Questions List\", \"nl\": \"Lijst van vragen\", \"ru\": \"Список вопросов\"}","Referendapartij":"{\"en\": \"Referendapartij\", \"nl\": \"stemNLwijzer.nl - directe democratie\", \"ru\": \"Referendapartij\"}","Res":"{\"en\": \"Result\", \"nl\": \"Resultaat\", \"ru\": \"Результат\"}","Result":"{\"en\": \"Result\", \"nl\": \"Resultaat\", \"ru\": \"Результат\"}","ResultSoon":"{\"en\": \" Result will be soon\", \"nl\": \" Result will be soon\", \"ru\": \"Результат будет скоро\"}","Save":"{\"en\": \"Save\", \"nl\": \"Bewaren\", \"ru\": \"Сохранить\"}","Search":"{\"en\": \"Search\", \"ru\": \"Поиск\"}","SearchAppbyName":"{\"en\": \"Search applications by name:\", \"ru\": \"Поиск приложения по названию:\"}","ShowAll":"{\"en\": \"Show all\", \"ru\": \"Показать все\"}","Start":"{\"en\": \"Start\", \"nl\": \"Sart\", \"ru\": \"Начало\"}","StartVote":"{\"en\": \"Start Vote\", \"nl\": \"Begin stemmen\", \"ru\": \"Начать голосование\"}","Stp":"{\"en\": \"Stop\", \"nl\": \"Stop\", \"ru\": \"Стоп\"}","Strt":"{\"en\": \"Start\", \"nl\": \"Sart\", \"ru\": \"Начало\"}","Synonym":"{\"en\": \"Synonym\", \"ru\": \"Синоним\"}","TEST_WARNING":"{\"en\": \"LOCALIZED_TEST\"}","TotalVoted":"{\"en\": \"Total voted\", \"nl\": \"Aantal stemmen\", \"ru\": \"Всего проголосовало\"}","TypeIssue":"{\"en\": \"Type\", \"nl\": \"Type\", \"ru\": \"Тип опроса\"}","View":"{\"en\": \"View\", \"nl\": \"Uitzicht\", \"ru\": \"Смотреть\"}","Vote":"{\"en\": \"Vote\", \"nl\": \"Stemmen\", \"ru\": \"Голосовать\"}","Voting":"{\"en\": \"Voting\", \"nl\": \"Stemmen\", \"ru\": \"Голосование\"}","VotingFinished":"{\"en\": \" Voting finished\", \"nl\": \"Ende stemmen\", \"ru\": \"Голосование закончено\"}","Vw":"{\"en\": \"View\", \"nl\": \"Uitzicht\", \"ru\": \"Смотреть\"}","Welcome":"{\"en\": \"Welcome\", \"nl\": \"Welkom\", \"ru\": \"Добро пожаловать\"}","Y":"{\"en\": \"Yes\", \"nl\": \"Ja\", \"ru\": \"Да\"}","Yes":"{\"en\": \"Yes\", \"nl\": \"Ja\", \"ru\": \"Да\"}","YouVoted":"{\"en\": \"You voted for all available issues\", \"nl\": \"U stemt op alle beschikbare onderwerpen\", \"ru\": \"Вы проголосовали за все доступные вопросы\"}","YourAnswer":"{\"en\": \"Your Answer\", \"nl\": \"Uw antwoord\", \"ru\": \"Ваш ответ\"}","address":"{\"en\": \"Address\"}","area":"{\"en\": \"Area\"}","buildings_use_class":"{\"en\": \"Buildings use class\"}","coords":"{\"en\": \"Coords\"}","dateformat":"{\"en\": \"YYYY-MM-DD\", \"ru\": \"DD.MM.YYYY\"}","female":"{\"en\": \"Female\", \"ru\": \"Женский\"}","land_use":"{\"en\": \"Land use\"}","male":"{\"en\": \"Male\", \"ru\": \"Мужской\"}","name_first":"{\"en\": \"First name\", \"ru\": \"Имя\"}","name_last":"{\"en\": \"Last name\", \"ru\": \"Фамилия\"}","name_middle":"{\"en\": \"Middle name\", \"ru\": \"Отчество\"}","qes1":"{\"en\": \"the first question \", \"nl\": \"De eerste vraag\"}","ques1":"{\"en\": \"the first question \", \"nl\": \"De eerste vraag\"}","timeformat":"{\"en\": \"YYYY-MM-DD HH:MI:SS\", \"ru\": \"DD.MM.YYYY HH:MI:SS\"}","voting":"{\"en\": \"voting\", \"ru\": \"voting\"}","voting_actions":"{\"en\": \"Actions\", \"ru\": \"Actions\"}","voting_create":"{\"en\": \"Create new\", \"ru\": \"Create new\"}","voting_creator":"{\"en\": \"Creator\", \"ru\": \"Creator\"}","voting_decision":"{\"en\": \"Subject of voting\", \"ru\": \"Subject of voting\"}","voting_decisions_candidate_manual":"{\"en\": \"Role candidates with manual registration of participants\", \"ru\": \"Role candidates with manual registration of participants\"}","voting_decisions_candidate_requests":"{\"en\": \"Role candidates with registration of participants by request\", \"ru\": \"Role candidates with registration of participants by request\"}","voting_decisions_db":"{\"en\": \"Formal decision\", \"ru\": \"Formal decision\"}","voting_decisions_document":"{\"en\": \"Document approval\", \"ru\": \"Document approval\"}","voting_decisions_set":"{\"en\": \"Set goal\", \"ru\": \"Set goal\"}","voting_description":"{\"en\": \"Description\", \"ru\": \"Description\"}","voting_end":"{\"en\": \"End date\", \"ru\": \"End date\"}","voting_end_desc":"{\"en\": \"End date for voting\", \"ru\": \"End date for voting\"}","voting_error":"{\"en\": \"Error\", \"ru\": \"Error\"}","voting_error_not_exists":"{\"en\": \"Requested entry does not exist\", \"ru\": \"Requested entry does not exist\"}","voting_invite":"{\"en\": \"Invite\", \"ru\": \"Invite\"}","voting_list":"{\"en\": \"voting list\", \"ru\": \"voting list\"}","voting_participant_id":"{\"en\": \"Citizen ID\", \"ru\": \"Citizen ID\"}","voting_participants":"{\"en\": \"Invited participants\", \"ru\": \"Invited participants\"}","voting_participants_everybody":"{\"en\": \"Anybody\", \"ru\": \"Anybody\"}","voting_participants_manual":"{\"en\": \"Choose manually\", \"ru\": \"Choose manually\"}","voting_participants_role":"{\"en\": \"By role\", \"ru\": \"By role\"}","voting_prestart":"{\"en\": \"Start date for applications\", \"ru\": \"Start date for applications\"}","voting_quorum":"{\"en\": \"Quorum\", \"ru\": \"Quorum\"}","voting_quorum_desc":"{\"en\": \"Percentage value of total participiants to fulfill requirements of this poll (from 5 to 100)\", \"ru\": \"Percentage value of total participiants to fulfill requirements of this poll (from 5 to 100)\"}","voting_start":"{\"en\": \"Start date\", \"ru\": \"Start date\"}","voting_start_desc":"{\"en\": \"Start date for voting\", \"ru\": \"Start date for voting\"}","voting_view":"{\"en\": \"View\", \"ru\": \"View\"}","voting_volume":"{\"en\": \"Volume\", \"ru\": \"Volume\"}","voting_volume_desc":"{\"en\": \"Percentage value of votes to fulfill requirements of this poll (from 50 to 100)\", \"ru\": \"Percentage value of votes to fulfill requirements of this poll (from 50 to 100)\"}","voting_voting_participants":"{\"en\": \"Voting participants\", \"ru\": \"Voting participants\"}"}`)
TextHidden(l_lang)
