go-version [![Build Status](https://travis-ci.org/mcuadros/go-version.png?branch=master)](https://travis-ci.org/mcuadros/go-version) [![GoDoc](https://godoc.org/github.com/GACHAIN/go-gachain-mvp/vendor/src/github.com/mcuadros/go-version?status.png)](http://godoc.org/github.com/GACHAIN/go-gachain-mvp/vendor/src/github.com/mcuadros/go-version)
==============================
...
```
go get github.com/GACHAIN/go-gachain-mvp/vendor/src/github.com/mcuadros/go-version
```
...
```go
import (
    "github.com/GACHAIN/go-gachain-mvp/vendor/src/github.com/mcuadros/go-version"
)
```
